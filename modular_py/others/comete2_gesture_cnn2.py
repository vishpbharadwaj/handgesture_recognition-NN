...
Fsize_params["fsize1"] = 5 # filter size of n*n for convolution
Fnum_params["fnum1"] = 6 # No. of filters required
Stride_params["stride1"] = [1,2,2,1]
Maxpool_ops["pool1"] = True #change here if pooling not required
...
### FC layer params
num_fc_layers = 2
fc_shape_last_cnn = 400 #"this is done because tf.reshape had some issues"
